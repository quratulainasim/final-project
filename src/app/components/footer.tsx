      ...
      <footer className="bg-black text-white py-8 px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-6 border-b border-gray-700 pb-8">
          ...
          <div className="flex justify-start lg:justify-end items-start gap-4">
            <FaTwitter className="text-lg cursor-pointer hover:text-slate-200" />
            <FaFacebook className="text-lg cursor-pointer hover:text-slate-200" />
            <FaYoutube className="text-lg cursor-pointer hover:text-slate-200" />
            <FaInstagram className="text-lg cursor-pointer hover:text-slate-200" />
          </div>
        </div>
